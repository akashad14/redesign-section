...
const ExpertiseSection: React.FC = () => {
  return (
    <div className="bg-gray-100 py-20 dark:bg-neutral-950">
      <div className="max-w-4xl mx-auto text-center mb-8">
        <h2 className="text-5xl font-bold text-gray-800 dark:text-gray-300">Our Areas of Expertise</h2>
      ...
      <div className="fill-violet-500 w-20 h-20">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48" height="48" fill="violet-500"><path d="M15 4H5V20H19V8H15V4ZM3 2.9918C3 2.44405 3.44749 2 3.9985 2H16L20.9997 7L21 20.9925C21 21.5489 20.5551 22 20.0066 22H3.9934C3.44476 22 3 21.5447 3 21.0082V2.9918ZM13.529 14.4464C11.9951 15.3524 9.98633 15.1464 8.66839 13.8284C7.1063 12.2663 7.1063 9.73367 8.66839 8.17157C10.2305 6.60948 12.7631 6.60948 14.3252 8.17157C15.6432 9.48951 15.8492 11.4983 14.9432 13.0322L17.1537 15.2426L15.7395 16.6569L13.529 14.4464ZM12.911 12.4142C13.6921 11.6332 13.6921 10.3668 12.911 9.58579C12.13 8.80474 10.8637 8.80474 10.0826 9.58579C9.30156 10.3668 9.30156 11.6332 10.0826 12.4142C10.8637 13.1953 12.13 13.1953 12.911 12.4142Z"></path>
      </svg>
      </div>
      <h1 className="font-bold text-xl dark:text-gray-300">Job Posting and Management</h1>
      <p className="text-sm text-zinc-500 leading-6 dark:text-gray-400">
    ...
    <div className="w-64 bg-white shadow-[0px_0px_15px_rgba(0,0,0,0.09)] p-9 space-y-3 relative  overflow-hidden dark:bg-gray-800">
      ...
      <h1 className="font-bold text-xl dark:text-gray-300">Advanced Applicant Tracking</h1>
      <p className="text-sm text-zinc-500 leading-6 dark:text-gray-400">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse fuga
        adipisicing elit
      </p>
    ...
    <div className="w-64 bg-white shadow-[0px_0px_15px_rgba(0,0,0,0.09)] p-9 space-y-3 relative  overflow-hidden dark:bg-gray-800">
      ...
      <div className="fill-violet-500 w-20 h-20">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48" height="48" fill="violet-500"><path d="M5 3V19H21V21H3V3H5ZM20.2929 6.29289L21.7071 7.70711L16 13.4142L13 10.415L8.70711 14.7071L7.29289 13.2929L13 7.58579L16 10.585L20.2929 6.29289Z"></path>
      </svg>
      </div>
      <h1 className="font-bold text-xl dark:text-gray-300">Candidate Profiling and Analytics</h1>
      <p className="text-sm text-zinc-500 leading-6 dark:text-gray-400">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse fuga
        adipisicing elit
      </p>
    ...
    <div className="w-64 bg-white shadow-[0px_0px_15px_rgba(0,0,0,0.09)] p-9 space-y-3 relative  overflow-hidden dark:bg-gray-800">
      ...
      <h1 className="font-bold text-xl dark:text-gray-300">Team Collaboration and Workflow Management</h1>
      <p className="text-sm text-zinc-500 leading-6 dark:text-gray-400">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse fuga
        adipisicing elit
      </p>
    ...
    <div className="w-64 bg-white shadow-[0px_0px_15px_rgba(0,0,0,0.09)] p-9 space-y-3 relative  overflow-hidden dark:bg-gray-800">
      ...
      <div className="fill-violet-500 w-20 h-20">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48" height="48" fill="violet-500"><path d="M17 2V4H20.0066C20.5552 4 21 4.44495 21 4.9934V21.0066C21 21.5552 20.5551 22 20.0066 22H3.9934C3.44476 22 3 21.5551 3 21.0066V4.9934C3 4.44476 3.44495 4 3.9934 4H7V2H17ZM7 6H5V20H19V6H17V8H7V6ZM9 16V18H7V16H9ZM9 13V15H7V13H9ZM9 10V12H7V10H9ZM15 4H9V6H15V4Z"></path>
      </svg>
      </div>
      <h1 className="font-bold text-xl dark:text-gray-300">Intelligent Resume Parsing</h1>
      <p className="text-sm text-zinc-500 leading-6 dark:text-gray-400">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse fuga
        adipisicing elit
      </p>
